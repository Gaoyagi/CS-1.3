...
def find_all_indexes(text, pattern):
    ...
    for t in range(len(text)):
        ...
        #         p+=1
        #         # print(pattern[p],"1")
        #         #check if you reached the end of the loop in the middle of finding a pattern:
        #         if t == len(text)-1:  
        #             del index[len(index)-1]     #delete the index from indexes because the pattern is broken
        #     #if you've finished finding 1 pattern
        #     else:
        #         p = 0
        #         # print(pattern[p],"2")
        #     t+=1    #go to the next character in text
        #     # print(text[t], "b")
        # else:
        #     #if they arent equal in the middle of a pattern
        #     if p>0:
        #         p = 0                 #reset the num counter
        #         # print(pattern[p], "3")
        #         del index[len(index)-1] #delete the index from indexes because the pattern is broken
        #     if text[t] == pattern[p]:
        #         # print("stuck here")
...
#assert find_all_indexes('abc', 'a') == [0]  # multiple letters are harder